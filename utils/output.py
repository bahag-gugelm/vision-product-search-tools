...
class RotatingTextWriter:
    def __init__(
        ...
        self.rollover_prefix = rollover_prefix \
            and f"_{rollover_prefix}_" or ""
    ...
    def do_rollover(self) -> None:
        ...
        self._file = Path(
            self._file.parent / 
            f"{self.fname}{self.rollover_prefix}{self.rollover_count}{self.fext}"
            )
        self.curr_lines_written = 0
